...
- **Top 3 Commits**:
  ...
  3. [Commit 3]() Finalized all files needed to edit; `problem.md`, `shanzaykhan.md`, and finished adding roles and proper commit links to all tasks oversawn. Also looked over all other member's work to ensure everything meets requirements. 
